...
```{r fig.width=11, fig.height=6, label="TotalStepsPerDay"}
...
```{r fig.width=11, fig.height=8, label="5-MinuteIntervals"}
     library(ggplot2)
...
```{r fig.width=11, fig.height=6, label="TotalStepsPerDay(ImputedData)"}
...
```{r fig.width=11, fig.height=8, label="5-MinuteIntervals(Weekend_vs_Weekday)"}
